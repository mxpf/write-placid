...
Published revisions may include an optional `updatedAt` frontmatter value. The article then shows a small “Last edited” note; first publications and untouched posts omit it.
